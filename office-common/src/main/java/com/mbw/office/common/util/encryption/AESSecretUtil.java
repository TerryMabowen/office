...
public class AESSecretUtil {
    ...
    public static String encryptToStr(String data, String key) {
        return StrUtil.isNotBlank(data) ? parseByte2HexStr(Objects.requireNonNull(encrypt(data, key))) : null;
    }
    ...
    public static String decryptToStr(String enCryptdata, String key) {
        return StrUtil.isNotBlank(enCryptdata) ? new String(Objects.requireNonNull(decrypt(parseHexStr2Byte(enCryptdata), key))) : null;
    }

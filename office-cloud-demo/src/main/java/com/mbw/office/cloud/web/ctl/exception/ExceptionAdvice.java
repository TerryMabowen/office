package com.mbw.office.cloud.web.ctl.exception;
 ...
 */
@Slf4j
@ControllerAdvice(basePackages = {"com.mbw.office.cloud.web.controller"})
public class ExceptionAdvice {
    ...
    private void handleAjaxException(HttpServletResponse response, Exception exception) throws IOException {
        ...
        printWriter.write(
                JacksonKit.beanToJson(ResponseResults.newFailed()

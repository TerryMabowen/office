...
import com.mbw.office.cloud.common.lang.exception.AssertException;
import com.mbw.office.cloud.common.kit.enums.EnumKit;
...
public class AssertKit {
    ...
    public static void assertEnumExist(int status, Class<? extends BaseEnumStatus> cls, String tips) {
        BaseEnumStatus value = EnumKit.getEnumByValue(cls, status);
        if (null == value) {
